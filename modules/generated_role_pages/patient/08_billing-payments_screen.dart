...
class PatientBillingPaymentsScreen extends StatelessWidget {
  const PatientBillingPaymentsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final pageSpec = DjoraaRoleCatalog.pageSpecsForRole(DjoraaRole.patient)[7];
