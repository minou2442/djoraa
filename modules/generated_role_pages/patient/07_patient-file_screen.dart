...
class PatientPatientFileScreen extends StatelessWidget {
  const PatientPatientFileScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final pageSpec = DjoraaRoleCatalog.pageSpecsForRole(DjoraaRole.patient)[6];
