...
class DoctorReportsHistoryScreen extends StatelessWidget {
  const DoctorReportsHistoryScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final pageSpec = DjoraaRoleCatalog.pageSpecsForRole(DjoraaRole.doctor)[5];
