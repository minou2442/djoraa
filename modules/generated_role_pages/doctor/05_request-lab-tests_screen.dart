...
class DoctorRequestLabTestsScreen extends StatelessWidget {
  const DoctorRequestLabTestsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final pageSpec = DjoraaRoleCatalog.pageSpecsForRole(DjoraaRole.doctor)[4];
