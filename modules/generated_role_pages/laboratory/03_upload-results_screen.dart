...
class LaboratoryUploadResultsScreen extends StatelessWidget {
  const LaboratoryUploadResultsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final pageSpec = DjoraaRoleCatalog.pageSpecsForRole(DjoraaRole.laboratory)[2];
