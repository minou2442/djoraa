...
class LaboratoryEquipmentLogsScreen extends StatelessWidget {
  const LaboratoryEquipmentLogsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final pageSpec = DjoraaRoleCatalog.pageSpecsForRole(DjoraaRole.laboratory)[3];
