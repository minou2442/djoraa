...
class PharmacyPharmacyDashboardScreen extends StatelessWidget {
  const PharmacyPharmacyDashboardScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final pageSpec = DjoraaRoleCatalog.pageSpecsForRole(DjoraaRole.pharmacy)[0];
