...
class RadiologyEditReportsScreen extends StatelessWidget {
  const RadiologyEditReportsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final pageSpec = DjoraaRoleCatalog.pageSpecsForRole(DjoraaRole.radiology)[3];
