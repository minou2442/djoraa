...
class RadiologyImageArchiveScreen extends StatelessWidget {
  const RadiologyImageArchiveScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final pageSpec = DjoraaRoleCatalog.pageSpecsForRole(DjoraaRole.radiology)[4];
