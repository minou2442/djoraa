...
class DentistRequestLabTestsScreen extends StatelessWidget {
  const DentistRequestLabTestsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final pageSpec = DjoraaRoleCatalog.pageSpecsForRole(DjoraaRole.dentist)[7];
