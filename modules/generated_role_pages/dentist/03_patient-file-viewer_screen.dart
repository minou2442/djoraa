...
class DentistPatientFileViewerScreen extends StatelessWidget {
  const DentistPatientFileViewerScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final pageSpec = DjoraaRoleCatalog.pageSpecsForRole(DjoraaRole.dentist)[2];
