...
class DentistNotificationsScreen extends StatelessWidget {
  const DentistNotificationsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final pageSpec = DjoraaRoleCatalog.pageSpecsForRole(DjoraaRole.dentist)[8];
